...
class GameState extends Phaser.State {
    ...
    preload() {
        this.game.load.atlasXML('sprites', 'assets/sprites.png', 'assets/sprites.xml');

        for (var i = 1; i <= 35; i++) {
            this.game.load.text('level_' + i, 'assets/levels/' + i);
        }

        for (let soundKey of ['background', 'bonus', 'moving', 'brick', 'explosion', 'fire', 'gameover', 'gamestart', 'score', 'steel']) {
    ...
    create() {
        ...
        for (var i = 0; i < 10; i++) {
            ...
            e.animations.add('boom', ['explosion1.png', 'explosion2.png', 'explosion3.png'], 60, false);
            e.animations.add('impact', ['explosion1.png', 'explosion2.png'], 60, false);
    ...
    update() {
        ...
        //  Run collisions
        this.game.physics.arcade.overlap(this.bullets, this.castles, this.destroyCastle, null, this);
        this.game.physics.arcade.overlap(this.bullets, this.bricks, this.hitBricks, null, this);
        this.game.physics.arcade.overlap(this.bullets, this.steelBlocks, this.hitSteel, null, this);
